...
def get_cifar10_data(flip_percentage):
    ...
    test_data = MyCIFAR10(args.data_path, train=False, transform=test_transform, download=True)
    raw_train_data = MyCIFAR10(args.data_path, train=True, transform=train_transform, download=True)
    ...
    if args.noise_type == 'ILN':
        train_data_for_noise = MyCIFAR10(args.data_path, train=True,
